...
/**
 * ответ на запрос информации о состояния оплаты договора, содержит данные по договору и статус оплаты
 */
@ApiModel(description = "ответ на запрос информации о состояния оплаты договора, содержит данные по договору и статус оплаты")
@Validated
public class AcquiringPaymentInfoRs   {
    @JsonProperty("uuid")
     ...
     */
    public AcquiringPaymentInfoRs(String uuid, Boolean needShowExist, Long insuranceId, String insuranceNumber, InsuranceStatusType insuranceStatus, ProgramKind programKind, Long programId, String programName, String currencyIso, BigDecimal paymentAmount, BigDecimal insuranceAmount, BigDecimal insurancePremium, LocalDate dateCreate, LocalDate startDate, LocalDate endDate, List<String> risks, String address, Long image, ShortClientData insured, Integer orderCode, Integer errorCode, String errorMessage) {
        this.uuid = uuid;
  ...
  @Valid
    ...
    public AcquiringPaymentInfoRs addRisksItem(String risksItem) {
        if (this.risks == null) {
  ...
  @Override
    public boolean equals(java.lang.Object o) {
        ...
        AcquiringPaymentInfoRs acquiringPaymentInfoRs = (AcquiringPaymentInfoRs) o;
        return Objects.equals(this.uuid, acquiringPaymentInfoRs.uuid) &&
            Objects.equals(this.needShowExist, acquiringPaymentInfoRs.needShowExist) &&
            Objects.equals(this.insuranceId, acquiringPaymentInfoRs.insuranceId) &&
            Objects.equals(this.insuranceNumber, acquiringPaymentInfoRs.insuranceNumber) &&
            Objects.equals(this.insuranceStatus, acquiringPaymentInfoRs.insuranceStatus) &&
            Objects.equals(this.programKind, acquiringPaymentInfoRs.programKind) &&
            Objects.equals(this.programId, acquiringPaymentInfoRs.programId) &&
            Objects.equals(this.programName, acquiringPaymentInfoRs.programName) &&
            Objects.equals(this.currencyIso, acquiringPaymentInfoRs.currencyIso) &&
            Objects.equals(this.paymentAmount, acquiringPaymentInfoRs.paymentAmount) &&
            Objects.equals(this.insuranceAmount, acquiringPaymentInfoRs.insuranceAmount) &&
            Objects.equals(this.insurancePremium, acquiringPaymentInfoRs.insurancePremium) &&
            Objects.equals(this.dateCreate, acquiringPaymentInfoRs.dateCreate) &&
            Objects.equals(this.startDate, acquiringPaymentInfoRs.startDate) &&
            Objects.equals(this.endDate, acquiringPaymentInfoRs.endDate) &&
            Objects.equals(this.risks, acquiringPaymentInfoRs.risks) &&
            Objects.equals(this.address, acquiringPaymentInfoRs.address) &&
            Objects.equals(this.image, acquiringPaymentInfoRs.image) &&
            Objects.equals(this.insured, acquiringPaymentInfoRs.insured) &&
            Objects.equals(this.orderCode, acquiringPaymentInfoRs.orderCode) &&
            Objects.equals(this.errorCode, acquiringPaymentInfoRs.errorCode) &&
            Objects.equals(this.errorMessage, acquiringPaymentInfoRs.errorMessage);
    }

    @Override
    public int hashCode() {
        return Objects.hash(uuid, needShowExist, insuranceId, insuranceNumber, insuranceStatus, programKind, programId, programName, currencyIso, paymentAmount, insuranceAmount, insurancePremium, dateCreate, startDate, endDate, risks, address, image, insured, orderCode, errorCode, errorMessage);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class AcquiringPaymentInfoRs {\n");
