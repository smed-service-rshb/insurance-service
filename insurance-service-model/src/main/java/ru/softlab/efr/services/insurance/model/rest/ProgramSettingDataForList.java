...
@Validated
public class ProgramSettingDataForList   {
    @JsonProperty("id")
     ...
     */
    public ProgramSettingDataForList() {}
     ...
     */
    public ProgramSettingDataForList(Long id, Long programId, String policyCode, ProgramKind programKind, String program, LocalDate startDate, LocalDate endDate, Integer minimumTerm, Integer maximumTerm, CalendarUnit calendarUnit, String currency, BigDecimal minSum, BigDecimal maxSum, BigDecimal minPremium, BigDecimal maxPremium) {
        this.id = id;
    ...
    **/
    @ApiModelProperty(required = true, value = "Идентификатор набора параметров программы страхования")
      @NotNull
 ...
 @Pattern(regexp="(^[A-Z]{3}$)")
  ...
  @Override
    public boolean equals(java.lang.Object o) {
        ...
        ProgramSettingDataForList programSettingDataForList = (ProgramSettingDataForList) o;
        return Objects.equals(this.id, programSettingDataForList.id) &&
            Objects.equals(this.programId, programSettingDataForList.programId) &&
            Objects.equals(this.policyCode, programSettingDataForList.policyCode) &&
            Objects.equals(this.programKind, programSettingDataForList.programKind) &&
            Objects.equals(this.program, programSettingDataForList.program) &&
            Objects.equals(this.startDate, programSettingDataForList.startDate) &&
            Objects.equals(this.endDate, programSettingDataForList.endDate) &&
            Objects.equals(this.minimumTerm, programSettingDataForList.minimumTerm) &&
            Objects.equals(this.maximumTerm, programSettingDataForList.maximumTerm) &&
            Objects.equals(this.calendarUnit, programSettingDataForList.calendarUnit) &&
            Objects.equals(this.currency, programSettingDataForList.currency) &&
            Objects.equals(this.minSum, programSettingDataForList.minSum) &&
            Objects.equals(this.maxSum, programSettingDataForList.maxSum) &&
            Objects.equals(this.minPremium, programSettingDataForList.minPremium) &&
            Objects.equals(this.maxPremium, programSettingDataForList.maxPremium);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, programId, policyCode, programKind, program, startDate, endDate, minimumTerm, maximumTerm, calendarUnit, currency, minSum, maxSum, minPremium, maxPremium);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ProgramSettingDataForList {\n");
