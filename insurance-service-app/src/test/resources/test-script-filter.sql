...
--insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'VIEW_CLIENT_CONTRACTS');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'VIEW_CONTRACT_LIST_ALL');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'VIEW_CONTRACT_LIST_RF_VSP');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'VIEW_CONTRACT_LIST_VSP');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'VIEW_CONTRACT_LIST_OWNER');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'VIEW_CONTRACT_REQUIRED_UNDERWRITING');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'CLIENT_VIEW_CONTRACT');
insert into rights_to_permission(permission_id, right_id) values ('view-contract', 'CLIENT_VIEW_CONTRACTS_LIST');
insert into rights_to_permission(permission_id, right_id) values ('view-contract-report', 'VIEW_CONTRACT_REPORT_ALL');
insert into rights_to_permission(permission_id, right_id) values ('view-contract-report', 'VIEW_CONTRACT_REPORT_RF_VSP');
insert into rights_to_permission(permission_id, right_id) values ('view-contract-report', 'VIEW_CONTRACT_REPORT_VSP');
insert into rights_to_permission(permission_id, right_id) values ('view-contract-report', 'VIEW_CONTRACT_REPORT_OWNER');
insert into rights_to_permission(permission_id, right_id) values ('view-dict', 'EDIT_PRODUCT_SETTINGS');
insert into rights_to_permission(permission_id, right_id) values ('view-dict', 'CREATE_CONTRACT');
insert into rights_to_permission(permission_id, right_id) values ('access-clients-info', 'VIEW_CLIENT');
insert into rights_to_permission(permission_id, right_id) values ('create-or-edit-clients', 'VIEW_CLIENT');
insert into rights_to_permission(permission_id, right_id) values ('create-or-edit-clients', 'EXECUTE_EDIT_CLIENT');
insert into rights_to_permission(permission_id, right_id) values ('create-or-edit-clients', 'EXECUTE_CREATE_CLIENT');
insert into rights_to_permission(permission_id, right_id) values ('inspect-edit-clients', 'INSPECT_EDIT_CLIENT');
insert into rights_to_permission(permission_id, right_id) values ('create-contract', 'CREATE_CONTRACT');
insert into rights_to_permission(permission_id, right_id) values ('create-contract', 'CREATE_CONTRACT_IN_CALL_CENTER');


-- Примеры тестовых сегментов программ страхования
INSERT INTO segment(id, version, code, name, isactive, deleted) VALUES (1, 0, 'retail', 'Массовый', true, false);
INSERT INTO segment(id, version, code, name, isactive, deleted) VALUES (2, 0, 'vip', 'Премиальный', true, false);
...
INSERT INTO program_v2(id, version, name, type, number, policycode, variant, coolingperiod, segment, isactive, deleted, relatedOfficeFilterType, relatedEmployeeGroupFilterType)
VALUES (2, 0, 'Купонный ИСЖ', 'ISJ', '002', 'Ю99', '01', 14, null, true, false, 'INCLUDE_ALL', 'INCLUDE_ALL');
INSERT INTO program_v2(id, version, name, type, number, policycode, variant, coolingperiod, segment, isactive, deleted, relatedOfficeFilterType, relatedEmployeeGroupFilterType)
...
INSERT INTO program_v2(id, version, name, type, number, policycode, variant, coolingperiod, segment, isactive, deleted, relatedOfficeFilterType, relatedEmployeeGroupFilterType)
VALUES (7, 0, 'Коробка', 'KSP', '007', 'K99', '01', 14, null, true, false, 'INCLUDE_ALL', 'INCLUDE_ALL');

INSERT INTO program_v2(id, version, name, type, number, policycode, variant, coolingperiod, segment, isactive, deleted, relatedOfficeFilterType, relatedEmployeeGroupFilterType)
VALUES                (8,  0,       'КСП','KSP','006', 'Д99',      '06',     14,            null,    true,     false, 'EXCLUDE', 'EXCLUDE');

INSERT INTO program_v2(id, version, name, type, number, policycode, variant, coolingperiod, segment, isactive, deleted, relatedOfficeFilterType, relatedEmployeeGroupFilterType)
VALUES                (9,  0,       'Тест фильтра по офису','ISJ','007', 'Я99',      '06',     14,            null,    true,     false, 'EXCLUDE_ALL', 'INCLUDE_ALL');
...
insert into audit_envers_info (id, timestamp) VALUES (0, datediff('ms', '1970-01-01', now()));
...
INSERT INTO program_setting(id, version, program, startdate, enddate, policyholderinsured,
                            ...
                            maxupperpressure, minupperpressure, maxlowerpressure, minlowerpressure, guarantee_level, deleted)
...
insert into strategy_2_program_setting (strategyid, programsettingid) VALUES (1, 1);
insert into strategy_2_program_setting (strategyid, programsettingid) VALUES (2, 1);
...
VALUES (2, 0, (SELECT id FROM program_v2 WHERE name = 'Купонный ИСЖ'), CURRENT_DATE, CURRENT_DATE, true,
        1, 100, 'YEAR', 1, 1, 100,
        100, 200, 'FIXED', 2.1, null,
        'ONCE', 'NO_STATEMENT', 18, 54, 18,
        54, 100, 220, 45, 220, 'MALE',
        120, 100, 100, 60, false);

insert into strategy_2_program_setting (strategyid, programsettingid) VALUES (1, 2);
INSERT INTO program_setting(id, version, program, startdate, enddate, policyholderinsured,
                            minimumterm, maximumterm, calendarunit, currency, minsum, maxsum,
                            minpremium, maxpremium, premiummethod, coefficient, bonusamount, insuranceamount, tariff,
                            periodicity, underwriting, minageholder, maxageholder, minageinsured,
...
INSERT INTO program_setting(id, version, program, startdate, enddate, policyholderinsured,
                            ...
                            maxageinsured, mingrowth, maxgrowth, minweight, maxweight, gender,
                            maxupperpressure, minupperpressure, maxlowerpressure, minlowerpressure, guarantee_level, deleted)
VALUES (11, 0, (SELECT ID FROM program_v2 where name = 'Тест фильтра по офису'), CURRENT_DATE, CURRENT_DATE, true,
        1, 100, 'YEAR', 1, 1, 100,
        100, 200, 'BY_FORMULA', 2.1, null, null, 100,
        'ONCE', 'NO_STATEMENT', 18, 54, 18,
        54, 100, 220, 45, 220, 'MALE',
...
insert into required_document(id, version, type, active, deleted) VALUES (1, 0, 'Документ, удостоверяющий личность.', true, false);
insert into required_document(id, version, type, active, deleted) VALUES (2, 0, 'Платежное поручение/платежный документ.', true, false);
insert into required_document(id, version, type, active, deleted) VALUES (3, 0, 'Форма самосертификации.', true, false);
...
insert into risk (id, version, program_kind, name, full_name, start_date, end_date, payment_method, benefits_insured, deleted) values (1, 0, 'ISJ', 'ЖИТИЕ МОЕ', 'ЖИТИЕ МОЕ', null, null, 'ONCE', TRUE, false);

insert into risk (id, version, program_kind, name, full_name, start_date, end_date, payment_method, benefits_insured, deleted) values (16, 0, 'ISJ', 'Дожитие', 'Дожитие', null, null, 'ONCE', TRUE, false);

insert into risk (id, version, program_kind, name, full_name, start_date, end_date, deleted) values (2, 0, 'ISJ', 'Смерть по любой причине', 'Смерть по любой причине', null, null, false);
insert into risk (id, version, program_kind, name, full_name, start_date, end_date, deleted) values (3, 0, 'ISJ', 'Смерть в результате несчастного случая', 'Смерть в результате несчастного случая', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (4, 0, 'ISJ', 'Смерть в результате кораблекрушения / авиакатастрофы / крушения поезда', 'Смерть в результате кораблекрушения / авиакатастрофы / крушения поезда', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (5, 0, 'NSJ', 'Дожитие', 'Дожитие', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (6, 0, 'NSJ', 'Смерть по любой причине', 'Смерть по любой причине', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (7, 0, 'NSJ', 'Смерть от несчастного случая', 'Смерть от несчастного случая', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (8, 0, 'NSJ', 'Инвалидность I группы', 'Инвалидность I группы', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (9, 0, 'NSJ', 'Травма', 'Травма', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (10, 0, 'NSJ', 'Госпитализация в результате НС', 'Госпитализация в результате НС', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (11, 0, 'NSJ', 'Временная нетрудоспособность в результате НС', 'Временная нетрудоспособность в результате НС', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (12, 0, 'NSJ', 'Смерть по любой причине', 'Смерть по любой причине', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (13, 0, 'NSJ', 'Инвалидность I, II группы по любой причине.', 'Инвалидность I, II группы по любой причине.', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (14, 0, 'NSJ', 'Инвалидность I, II, III группы НС.', 'Инвалидность I, II, III группы НС.', null, null, false);
insert into risk (id, version,program_kind, name, full_name, start_date, end_date, deleted) values (15, 0, 'NSJ', 'Инвалидность I, II, III группы по любой причине', 'Инвалидность I, II, III группы по любой причине', null, null, false);

INSERT INTO insurance_status(id, code, name) VALUES (1, 'DRAFT', 'Котировка');
INSERT INTO insurance_status_AUD(id, code, name, REV, REVTYPE) VALUES (1, 'DRAFT', 'Котировка', 0, 0);
INSERT INTO insurance_status(id, code, name) VALUES (2, 'PROJECT', 'Проект');
INSERT INTO insurance_status_AUD(id, code, name, REV, REVTYPE) VALUES (2, 'PROJECT', 'Проект', 0, 0);
INSERT INTO insurance_status(id, code, name) VALUES (3, 'MADE', 'Оформлен');
INSERT INTO insurance_status_AUD(id, code, name, REV, REVTYPE) VALUES (3, 'MADE', 'Оформлен', 0, 0);
...
INSERT INTO insurance_status(id, code, name) VALUES (13, 'MADE_NOT_COMPLETED', 'Оформление не завершено');
INSERT INTO insurance_status(id, code, name) VALUES (14, 'REVOKED_REPLACEMENT', 'Анулирование по замене');
INSERT INTO insurance_status(id, code, name) VALUES (15, 'PAYED', 'Оплачен');

-- Тестовые параметры рисков
INSERT INTO risk_setting(
    id, version, risktype, risk, signamount, minriskamount, maxriskamount,
...
INSERT INTO risk_2_program_setting(
    riskid, programsettingid)
VALUES (1, 8);
...
INSERT INTO optional_risk_2_program_setting(
    riskid, programsettingid)
VALUES (1, 1);
INSERT INTO optional_risk_2_program_setting(
    riskid, programsettingid)
...
INSERT INTO clients(
    id, surname, firstname, middlename, birth_date, gender, birth_place,
...
INSERT INTO addresses_for_client(
  id, address_type, country, region, area, city, locality, street,
...
INSERT INTO phones_for_client(
    id, phone_type, number, main, verified, notification, client_id)
VALUES (1, 'MOBILE', '+791100000001', true, true, true, 1);
INSERT INTO phones_for_client(
    id, phone_type, number, main, verified, notification, client_id)
...
insert into insurance (id, creation_date, contract_number, branch_name, subdivision_name, subdivision_Id, employee_id,
                       ...
                       holder_equals_insured, insured_id, duration, start_date, currency, premium, rur_premium, amount,
                       rur_amount, periodicity, status_id, recipient_equals_holder, calendar_unit, paymentterm,
                       conclusiondate, full_set_document, strategy_id, guarantee_level)
VALUES (9, TIMESTAMP '2018-12-12 12:12:12', '23К010110000002', 'Амурский РФ', '2310', 2, 9, 'Фёдоров Фёдор Фёдорович',
        2, 1, false, 9, 1, TRUE, 9, 4, TIMESTAMP '2018-12-27', 1, 1000, 1000, 10000, 10000, 'ONCE', 3, TRUE, 'YEAR', 10,
        TIMESTAMP '2018-12-12 12:12:12', false, 2, 22);
...
VALUES (10, TIMESTAMP '2018-12-15 15:15:15', '23К010110000003', 'Амурский РФ', '2310', 2, 9, 'Фёдоров Фёдор Фёдорович',
        ...
        TIMESTAMP '2018-12-15 15:15:15', true);
...
VALUES (11, TIMESTAMP '2010-12-15 15:15:15', '23К010110009123', 'Амурский РФ', '2310', 2, 9, 'Фёдоров Фёдор Фёдорович',
        8, 1, false, 9, 1, TRUE, 9, 4, TIMESTAMP '2010-12-28', 1, 1000, 1000, 10000, 10000, 'ONCE', 3, TRUE, 'YEAR', 10,
...
insert into insurance (id, creation_date, contract_number, branch_name, subdivision_name, subdivision_Id, employee_id,
                       ...
                       rur_amount, periodicity, status_id, recipient_equals_holder, calendar_unit, paymentterm,
                       conclusiondate, full_set_document)
VALUES (12, TIMESTAMP '2010-12-15 15:15:15', '23К010110019124', 'Амурский РФ', '1111', 55, 45, 'Фёдоров Фёдор Фёдорович',
        11, 1, false, 9, 1, TRUE, 2, 4, TIMESTAMP '2010-12-28', 1, 1000, 1000, 10000, 10000, 'ONCE', 3, TRUE, 'YEAR', 10,
        TIMESTAMP '2010-12-15 15:15:15', false);
...
insert into insurance (id, creation_date, contract_number, branch_name, subdivision_name, subdivision_Id, employee_id,
                       ...
                       rur_amount, periodicity, status_id, recipient_equals_holder, calendar_unit, paymentterm,
                       conclusiondate, full_set_document)
VALUES (13, TIMESTAMP '2010-12-15 15:15:15', '23К010110019129', 'Амурский РФ', '1111', 55, 45, 'Фёдоров Фёдор Фёдорович',
        11, 1, false, 4, 1, TRUE, 2, 4, TIMESTAMP '2010-12-28', 1, 1000, 1000, 10000, 10000, 'ONCE', 15, TRUE, 'YEAR', 10,
        TIMESTAMP '2010-12-15 15:15:15', false);
...
insert into extract(uuid, request_digest, name, content, status, type) values
('d1bd76e2-5762-4b6a-adee-5c5c46826240', 'fd85e710644641578466c25d9bb5f9e7', 'Отчёт по продажам ISJ с 2016-07-08 по 2018-12-20.xlsx', rawtohex('1'), 'CREATING', 'SALE_REPORT');
...
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (1, 1, 'FIELD_SET', 'documents', 'Документы клиента', null, false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (2, 1, 'FIELD', 'riskLevel', 'Уровень риска', null, false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (3, 1, 'FIELD', 'docSeries', 'Серия документа', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (4, 1, 'FIELD', 'docNumber', 'Номер документа', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (5, 1, 'FIELD', 'issuedBy', 'Кем выдан документ', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (6, 1, 'FIELD', 'issuedDate', 'Когда выдан документ', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (7, 1, 'FIELD', 'isActive', 'Признак активности', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (8, 1, 'FIELD', 'isMain', 'Признак основного документа', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (9, 1, 'FIELD', 'divisionCode', 'Код подразделения', (SELECT id FROM required_field WHERE strid = 'documents'), false);
INSERT INTO required_field(id, version, type, strid, name, parent, deleted) VALUES (10, 1, 'FIELD', 'issuedEndDate', 'Дата окончания действия документа', (SELECT id FROM required_field WHERE strid = 'documents'), false);

INSERT INTO required_field_2_program_setting(
  requiredfieldid, programsettingid)
VALUES (1, 3);

INSERT INTO required_document_setting(
  id, version, requireddocument, status, deleted)
...
INSERT INTO required_document_setting_2_program_setting(
  requireddocumentsettingid, programsettingid)
VALUES (1, 3);
INSERT INTO required_document_setting_2_program_setting(
  requireddocumentsettingid, programsettingid)
VALUES (2, 3);
...
INSERT INTO insurance_2_recipient(
  id, insurance_id, surname, first_name, middle_name, birth_date,
...
INSERT INTO insurance_2_recipient(
  id, insurance_id, surname, first_name, middle_name, birth_date,
  birth_place, tax_residence, relationship, share, birth_country)
VALUES (2, 2, 'ЕщёДлиннееОченьДлиннаяФамилия2', 'ОченьДлинноеИмя2', 'ОченьДлинноеОтчество', TIMESTAMP '1980-01-01 12:12:12',
...
INSERT INTO insurance_2_risk_info(
  id, risk_id, insurance_id, amount, underwriting_rate, premium)
...
INSERT INTO insurance_status_history(
  id, insurance_id, status_id, change_date, employee_id, employee_name,
...
--
INSERT INTO orders(
  id, creation_date, contract_id, client_id, amount, currency_iso_code,
  ext_id, redirect_url, order_code, error_code, error_message,
  pan, expiration, card_holder_name, ip, modified_date)
VALUES (1, TIMESTAMP '2019-02-19 12:26:11', null, null, 1234, 810,
        null, null, null, null, null,
...
INSERT INTO orders(
  ...
  ext_id, redirect_url, order_code, error_code, error_message,
  pan, expiration, card_holder_name, ip, modified_date)
VALUES (2, TIMESTAMP '2019-02-20 12:26:11', null, 2, 1234, 810,
        null, null, null, null, null,
        null, null, null, null, TIMESTAMP '2019-02-21 12:26:11');
...
insert into share (id, name) values (1, 'FUTURE1');
insert into share (id, name) values (2, 'FUTURE2');
insert into quote (share_id, date, value) values (1, TIMESTAMP '2018-12-18', 10);
insert into quote (share_id, date, value) values (1, TIMESTAMP '2019-02-10', 10);
insert into quote (share_id, date, value) values (2, TIMESTAMP '2019-02-10', 10);
insert into quote (share_id, date, value) values (1, TIMESTAMP '2019-02-11', 11);
insert into quote (share_id, date, value) values (1, TIMESTAMP '2019-02-12', 12);
insert into share_2_strategy (share_id, strategy_id) values (1, 2 );
insert into share_2_strategy (share_id, strategy_id) values (2, 2 );

alter table base_index add UNIQUE (date, strategy_name);
insert into base_index (strategy_name, date, value) values ('Глобальные облигации', TIMESTAMP '2018-12-17', 1368.16);
insert into base_index (strategy_name, date, value) values ('Глобальные облигации', TIMESTAMP '2018-12-18', 1399.7);
insert into base_index (strategy_name, date, value) values ('Глобальные облигации', TIMESTAMP '2018-12-27', 1367.61);
insert into base_index (strategy_name, date, value) values ('Глобальные облигации', TIMESTAMP '2018-12-28', 1368);
insert into base_index (strategy_name, date, value) values ('Глобальные облигации', TIMESTAMP '2018-12-29', 1399.7);

insert into base_index_2_strategy (base_index_date, strategy_name, strategy_id) values (TIMESTAMP '2018-12-17', 'Глобальные облигации', 1);
insert into base_index_2_strategy (base_index_date, strategy_name, strategy_id) values (TIMESTAMP '2018-12-18','Глобальные облигации', 1);
insert into base_index_2_strategy (base_index_date, strategy_name, strategy_id) values (TIMESTAMP '2018-12-27','Глобальные облигации', 1);
insert into base_index_2_strategy (base_index_date, strategy_name, strategy_id) values (TIMESTAMP '2018-12-28','Глобальные облигации', 1);
insert into base_index_2_strategy (base_index_date, strategy_name, strategy_id) values (TIMESTAMP '2018-12-29','Глобальные облигации', 1);
