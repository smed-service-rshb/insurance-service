...
//                .andExpect(MockMvcResultMatchers.jsonPath("$.validationErrors[10].value", is("Необходимо прикрепить скан: Платежное поручение/платежный документ.")))
    ...
    public void putContractSuccess() throws Exception {
        ...
        mockMvc.perform(get(GET_CONTRACT_BY_ID_REQUEST, 2)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.amount", is(270000.00)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.rurAmount", is(270000.00)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.premium", comparesEqualTo(10000.00)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.rurPremium", comparesEqualTo(10000.00)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.premiumWithoutDiscount", comparesEqualTo(300000.00)))
